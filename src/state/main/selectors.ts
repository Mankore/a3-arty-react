...
export const selectArtillery = createSelector(selectDomain, (main) => main.artillery);

export const selectFireMode = createSelector(selectDomain, (main) => main.fireMode);
